...
![Four ex-mining Sapphire Pulse RX 5600 XT cards on an open frame, repurposed as a local LLM inference server](images/ex-mining-llm/rig.jpg)
## TL;DR
...
<p align="center">
  <img src="images/ex-mining-llm/tps-before.png" width="48%" alt="llama-server API response at 0.22 tokens/sec, decode split across four cards over x1 Gen1 risers">
  <img src="images/ex-mining-llm/tps-after.png" width="48%" alt="the same endpoint at 40 tokens/sec after pinning to a single card with MESA_VK_DEVICE_SELECT">
</p>
